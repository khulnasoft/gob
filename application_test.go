...
func (m mockUI) Setup(_ pulsebus.Unsubscribable) error {
	return nil
}

func (m mockUI) Handle(_ pulsebus.Event) error {
	return nil
}
...
func Test_Application_Setup_WiresGif(t *testing.T) {
	name := "puppy"
	version := "2.0"
...
var _ gfi.FlagAdder = (*persistent)(nil)

func (t *persistent) AddFlags(flags gfi.FlagSet) {
...
var _ gfi.FlagAdder = (*f1)(nil)

func (t *f1) AddFlags(flags gfi.FlagSet) {
...
func Test_RunExitError(t *testing.T) {
	...
	cmd.Env = append(os.Environ(), fmt.Sprintf("GOB_LOG_FILE=%s", logFile), "GOB_RUN_EXIT_ERROR=YES")
