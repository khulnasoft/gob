...
// NewApplication takes a testing.T, a gob setup config, and a slice of assertions, and returns
// a gob application that will, instead of setting up commands with their normal RunE, set up commands
...
// Note that initializers will be cleared from the gob setup config, since the initialization may happen
