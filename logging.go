...
func DefaultLogger(gobCfg Config, store redact.Store) (logger.Logger, error) {
	cfg := gobCfg.Log
	if cfg == nil {
...
func (l *LoggingConfig) DescribeFields(d gfi.FieldDescriptionSet) {
...
func (l *LoggingConfig) AddFlags(flags gfi.FlagSet) {
